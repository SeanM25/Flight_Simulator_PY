...
class WindModel:
   ...
   def Update(self, uu=None, uv=None, uw=None):
    ...
    Xu_minus = new_Xu_state # Set old u state to new u state
    ...
    Xv_minus = new_Xv_state # Set old v state to new v state
    ...
    Xw_minus = new_Xw_state # Set old w state to new w state
